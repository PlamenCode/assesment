        ...
        <Accordion>
            ...
            (<Card key={val.number}>
                <Card.Header>
                    <Row>
                        <Col>
                            <Accordion.Toggle as={Button} variant="link" eventKey={state.headings!.indexOf(val).toString()}>
                        ...
                        <Col>
                            <Button onClick={() => {
                                setState({ ...state, showHeadingModal: true, currentHeading: val })
                            }}>Edit
                            </Button></Col>
                    </Row>
                </Card.Header>
                        ...
                        <Row className="justify-content-md-center">
                            ...
                            <Col>
                                {val.lines?.length ? <>
                                    ...
                                    : <>
                                        <h3>No lines set</h3>
                                        <Button variant="success" onClick={_ => setState({
                                            ...state,
                                            showLineModal: true,
                                            selectedHeading: val.number,
                                            linesPerCurrentHeading: val.lines?.map(sp => sp.number)
